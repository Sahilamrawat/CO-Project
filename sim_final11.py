# Dictionary mapping binary strings to register names
registers = {
...
zero = ra = sp = gp = tp = t0 = t1 = t2 = s0 = s1 = a0 = a1 = a2 = a3 = a4 = a5 = a6 = a7 = s2 = s3 = s4 = s5 = s6 = s7 = s8 = s9 = s10 = s11 = t3 = t4 = t5 = t6 = '00000000000000000000000000000000'

# Initialize stack pointer to point to 32nd bit
sp = '00000000000000000000000100000000'

# Initialize program counter to 4
pc = 4

# Initialize memory with all zeros
memory = {i: '00000000000000000000000000000000' for i in range(65536, 65661, 4)}
...
input_file = open("C:\\Users\\justu\\OneDrive\\Desktop\\CO\\CO project\\text.txt", 'r')
