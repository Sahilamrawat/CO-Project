registers = open("G:\\My Drive\\FINAL SIMULATOR\\regs.txt", "r").read()
registers = eval(registers)

output = open("G:\\My Drive\\FINAL SIMULATOR\\output.txt", 'w+')

from vars import *

memory = open("G:\\My Drive\\FINAL SIMULATOR\\memory.txt", 'r').read()
memory = eval(memory)
...
input_file = open("G:\\My Drive\\FINAL SIMULATOR\\text.txt", 'r')
